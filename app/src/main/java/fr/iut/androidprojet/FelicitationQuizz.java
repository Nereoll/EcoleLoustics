...
public class FelicitationQuizz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quitter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FelicitationQuizz.this, Activites.class);
        ...
        recommencer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FelicitationQuizz.this, QuizzActivity.class);
                startActivity(intent);
            }
        });
    }
